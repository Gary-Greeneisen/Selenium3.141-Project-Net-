...
namespace AcceptanceTests.PageObjects
{
    public partial class StudentSearchPage
    {
        ...
        public void WaitForAdvancedStudentSearch(int retrys)
        {
            ...
            {
                throw new Exception("Advanced Student Search Page Not Displayed");
            }

        }

        public bool IsAdvancedStudentSeachPageDisplayed()
        {
            bool isFound = false;
    ...
    } //end public partial class StudentSearchPage
